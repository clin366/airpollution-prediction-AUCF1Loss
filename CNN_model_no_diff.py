...
def run_keras_model(model, input_embedding, y_class, train_len, valid_len, test_len):
    ...
    model.fit(input_embedding[0:train_len+valid_len], y_class[0:train_len+valid_len], batch_size = 16, epochs = best_epoch,class_weight = class_weight, verbose=1)
